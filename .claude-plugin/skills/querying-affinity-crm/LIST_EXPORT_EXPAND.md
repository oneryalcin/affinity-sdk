...
Export list entries along with their associated entities (people, companies).
...
Output:
```csv
listEntryId,entityName,Status,people
...
|--------|------|---------|-------------|
| `--expand` | choice (repeatable) | - | Expand type: `people` or `companies` |
