...
This pre-commit hook regenerates mcp/.registry/commands.json when pyproject.toml
changes (indicating a version bump). This ensures the registry stays in sync
